...
public class ExecuteOrderCommandHandler implements CommandHandler<ExecuteOrderCommand> {
    ...
    public ExecuteOrderCommandHandler(EventBus eventBus, MessagePublisher queuePublisher, OrdersRepository repository,
    ...
    public void handle(ExecuteOrderCommand command) {
        ...
        this.eventBus.publish(new OrderExecutionSended(command));
        ...
        this.queuePublisher.publish(command);
    }
