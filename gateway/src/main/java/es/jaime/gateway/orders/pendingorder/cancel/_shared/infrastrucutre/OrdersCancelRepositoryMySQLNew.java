...
@Repository
public class OrdersCancelRepositoryMySQLNew extends DataBaseRepositoryValueObjects<CancelOrder, OrderId> implements OrdersCancelRepository {
    protected OrdersCancelRepositoryMySQLNew(DatabaseConnection databaseConnection) {
